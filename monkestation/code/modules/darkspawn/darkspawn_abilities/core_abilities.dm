...
/datum/action/cooldown/spell/touch/devour_will/cast(mob/living/carbon/cast_on)
	. = ..()
	playsound(owner, '/magic/devour_will_form.ogg', 50, 1)
...
/datum/action/cooldown/spell/touch/devour_will/cast_on_hand_hit(obj/item/melee/touch_attack/hand, mob/living/carbon/target, mob/living/carbon/caster)
	...
	playsound(target, 'monkestation/sound/ambience/antag/darkspawn/magic/devour_will_long.ogg', 65, FALSE)
	...
	playsound(target, 'monkestation/sound/ambience/antag/darkspawn/magic/devour_will_end.ogg', 75, FALSE)
	target.playsound_local(target, 'monkestation/sound/ambience/antag/darkspawn/magic/devour_will_victim.ogg', 50, FALSE)
...
/datum/action/cooldown/spell/touch/restrain_body/cast_on_hand_hit(obj/item/melee/touch_attack/hand, mob/living/carbon/target, mob/living/carbon/caster)
	...
	playsound(target, '/ambience/antag/veil_mind_gasp.ogg', 50, TRUE)
	tying = TRUE
	...
	playsound(target, '/magic/devour_will_form.ogg', 50, TRUE)
...
/datum/action/cooldown/spell/pointed/darkspawn_build/before_cast(atom/cast_on)
	...
	if(cast_time)
		...
		playsound(get_turf(owner), '/magic/devour_will_begin.ogg', 50, TRUE)
...
/datum/action/cooldown/spell/pointed/darkspawn_build/cast(atom/cast_on)
	...
	if(!object_type) //sanity check
		return
	playsound(get_turf(cast_on), '/magic/devour_will_end.ogg', 50, TRUE)
