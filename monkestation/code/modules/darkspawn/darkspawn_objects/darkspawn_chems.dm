...
/datum/movespeed_modifier/shadowfrost
	multiplicative_slowdown = 2

/datum/reagent/shadowfrost/on_mob_metabolize(mob/living/L)
	. = ..()
	L.add_movespeed_modifier(type)
...
/datum/reagent/darkspawn_darkness_smoke/expose_mob(mob/living/M, methods, reac_volume, show_message, permeability)
	. = ..()
