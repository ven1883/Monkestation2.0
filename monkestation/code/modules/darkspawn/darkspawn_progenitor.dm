/mob/living/simple_animal/hostile/darkspawn_progenitor
	...
	//flavour
	attack_sound = 'monkestation/sound/ambience/antag/darkspawn/creatures/progenitor_attack.ogg'
	attacktext = "rends"
...
/mob/living/simple_animal/hostile/darkspawn_progenitor/Initialize(mapload, darkspawn_name, class_colour = COLOR_DARKSPAWN_PSI)
	...
	addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(sound_to_playing_players), 'monkestation/sound/ambience/antag/darkspawn/magic/sacrament_complete.ogg', 50), 4 SECONDS, TIMER_UNIQUE)
...
/mob/living/simple_animal/hostile/darkspawn_progenitor/AttackingTarget()
	if(istype(target, /obj/machinery/door) || istype(target, /obj/structure/door_assembly))
		playsound(target, 'monkestation/sound/ambience/antag/darkspawn/sound/magic/pass_smash_door.ogg', 100, FALSE)
	. = ..()
...
/mob/living/simple_animal/hostile/darkspawn_progenitor/proc/roar()
	playsound(src, 'monkestation/sound/ambience/antag/darkspawn/creatures/progenitor_roar.ogg', 70, TRUE)
	for(var/mob/M in GLOB.player_list)
		if(get_dist(M, src) > 7)
			M.playsound_local(src, 'monkestation/sound/ambience/antag/darkspawn/creatures/progenitor_distant.ogg', 35, FALSE, falloff_exponent = 5)
