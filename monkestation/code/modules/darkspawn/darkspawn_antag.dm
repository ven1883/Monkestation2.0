...
/datum/antagonist/darkspawn/greet()
	...
	user.playsound_local(get_turf(user), 'monkestation/sound/ambience/antag/darkspawn/darkspawn.ogg', 50, FALSE)
	...
	if((owner?.current?.stat == DEAD) && HAS_TRAIT(src, TRAIT_DARKSPAWN_UNDYING) && ishuman(owner.current) && !QDELETED(owner.current))
		...
		if(light_amount < SHADOW_SPECIES_DIM_LIGHT)
			...
			if(deadguy.health >= deadguy.maxHealth)
				...
				playsound(deadguy, 'monkestation/sound/ambience/antag/darkspawn/magic/demented_outburst_scream.ogg', 40, FALSE)
...
/datum/antagonist/darkspawn/proc/begin_force_divulge()
	...
	owner.current.playsound_local(owner.current, 'monkestation/sound/ambience/antag/darkspawn/magic/divulge_01.ogg', 50, FALSE, pressure_affected = FALSE)
...
/datum/antagonist/darkspawn/proc/force_divulge()
	...
	playsound(H, 'monkestation/sound/ambience/antag/darkspawn/creatures/darkspawn_force_divulge.ogg', 50, FALSE)
...
/datum/antagonist/darkspawn/proc/reform_body()
	...
	playsound(returner, 'monkestation/sound/ambience/antag/darkspawn/magic/divulge_end.ogg', 50, 0)
	playsound(returner, 'monkestation/sound/ambience/antag/darkspawn/creatures/darkspawn_death.ogg', 50, 0)
...
/datum/antagonist/darkspawn/get_preview_icon()
	var/icon/darkspawn_icon = icon('monkestation/icons/mob/darkspawn/bodyparts.dmi', "darkspawn_head")
	darkspawn_icon.Blend(icon('monkestation/icons/mob/darkspawn/bodyparts.dmi', "darkspawn_chest"), ICON_OVERLAY)
	darkspawn_icon.Blend(icon('monkestation/icons/mob/darkspawn/bodyparts.dmi', "darkspawn_r_arm"), ICON_OVERLAY)
	darkspawn_icon.Blend(icon('monkestation/icons/mob/darkspawn/bodyparts.dmi', "darkspawn_l_arm"), ICON_OVERLAY)
	darkspawn_icon.Blend(icon('monkestation/icons/mob/darkspawn/bodyparts.dmi', "darkspawn_r_leg"), ICON_OVERLAY)
	darkspawn_icon.Blend(icon('monkestation/icons/mob/darkspawn/bodyparts.dmi', "darkspawn_l_leg"), ICON_OVERLAY)
